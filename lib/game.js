...
Game.prototype.generateGrid = function () {
  ...
  this.collisionMap[0][2].portal.right = [this.collisionMap[0][1], 'right']
  this.collisionMap[0][1].canPortal = true
  this.collisionMap[0][1].portal.right = [this.collisionMap[0][2], 'right']
}
